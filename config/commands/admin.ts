...
export const logs = {
  settings: {
    ...
    category: 'admin',
    command: 'logs',
    description: 'Active ou de désactive la sauvegarde des messages de certains salons.',
...
export const module = {
  settings: {
    ...
    category: 'admin',
    command: 'module',
    description: 'Active ou de désactive certains modules de Swan.',
...
export const runTask = {
  settings: {
    ...
    category: 'admin',
    command: 'run-task',
    description: 'Exécute immédiatement une tâche de Swan.',
...
export const reactionRole = {
  settings: {
    ...
    description: 'Crée un nouvel espace de reaction role.',
    examples: [
  ...
  messages: {
    success: "L'espace de reaction role a bien été créé. :white_check_mark:",
    embed: {
