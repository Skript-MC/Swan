...
class UncaughtExceptionListener extends Listener {
  ...
  exec(error) {
    ...
    if (process.env.NODE_ENV === 'production') {
      ...
      this.client.logger.warn('An unhandledRejection was caught. Swan is now in an undefined state. Continuing using it might lead to unforeseen and unpredictable issues.');
    }
  }
}
