...
class Purge extends Command_1.default {
    constructor() {
        super(...arguments);
        this.name = 'Purge';
        this.shortDescription = config_json_1.default.messages.commands.purge.shortDesc;
        this.longDescription = config_json_1.default.messages.commands.purge.longDesc;
        this.usage = `purge [@mention] <nombre>`;
        ...
        this.execute = (message, args) => __awaiter(this, void 0, void 0, function* () {
            ...
            if (amount > config_json_1.default.miscellaneous.purgeLimit)
                amount = config_json_1.default.miscellaneous.purgeLimit;
